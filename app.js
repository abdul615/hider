...
var api_user    = require('./webapi/users');
var api_userv1    = require('./webapi/usersv1');
var api_userv2    = require('./webapi/usersv2');
var app        = express();
...
app.use(function(req, res, next) {
    ...
    // else if(string_array['3'] == 'product2'){
    //     //global.cssJSUrl = req.protocol + '://' + req.headers.host + '/'+'backend';
    //     global.baseUrl = req.protocol + '://' + req.headers.host;
    //     app.set('layout', 'layouts/mainLayout');
    // }
...
app.use('/crons', crons);
app.use('/webapi/users', api_user);
app.use('/webapi/usersv1', api_userv1);
app.use('/webapi/usersv2', api_userv2);
